...
const headerElement = {
    header: () => {
        ...
        header.setAttribute("namespace", "header"); 
    ...
    headerContainer : () => {
        ...
        div.setAttribute("namespace" , "headerContainer")
    ...
    nav: () => {
        ...
        const routesView = [ "inicio", "servicos" , "cadastro" , "login"]

     const aLinked = routesView.map(item => {
